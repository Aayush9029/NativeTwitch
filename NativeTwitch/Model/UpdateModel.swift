...
let exampleUpdateModel = UpdateModel(published: "2021-10-27", version: "1.0", build: 4, title: "Play Using IINA", mainfeature: "You can now play streams using IINA instead of Quicktime.", downloadlink: "https://github.com/Aayush9029/NativeTwitch/releases/download/v4.0/NativeTwitch.app.zip", image: exampleImageModels)
